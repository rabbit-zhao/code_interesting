# -*- coding: utf-8 -*-
# @Author: zhr
# @Date:   2020-03-05 13:00:57
# @Last Modified by:   zhr
# @Last Modified time: 2020-03-05 13:06:51
import jieba
import re
import collections
import wordcloud
...
f1 = open("18 公共管理 尹文睿(2784379600).txt", "r", encoding="utf-8")
zhr_name = ["东都大白兔", "name=main", "今天必须早睡"]
zyf_name = ["18 公共管理 尹文睿"]
